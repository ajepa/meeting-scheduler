...
<html>
    <head>
        <meta charset="UTF-8">
        <title>Web Based Meeting Scheduler</title>
        <!-- demo stylesheet -->
    ...
    <body>
            <div id="header">
                <div class="bg-help">
                    <div class="inBox">
                        <h1 id="logo"><a href='http://code.daypilot.org/27453/html5-hotel-room-booking-javascript-php'>Web Based Meeting Scheduler</a></h1>
                        <p id="claim"><a href="http://javascript.daypilot.org/"></a> Schedule your meeting with ease</p>
                        <hr class="hidden" />
                    </div>
                </div>
            </div>
            ...
            <div class="main">
                ...
                <div class="space">
                    ...
                    <select id="filter">
                        ...
                        <option value="7">50 Seats</option>
                        <option value="8">25 Seats</option>
                        <option value="9">10 Seats</option>
                    </select>
                ...
                <script>
                    ...
                    dp.onBeforeResHeaderRender = function(args) {
                        var seat = function(count) {
                            return count + "seat" + (count > 1 ? "s" : "");
                        };
                        
                        args.resource.columns[0].html = seat(args.resource.capacity);
